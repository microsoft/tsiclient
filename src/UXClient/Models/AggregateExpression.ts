...
class AggregateExpression extends ChartableExpression {
	...
	constructor(predicateObject: any, measureObject: any, measureTypes: Array<string>, searchSpan: any, 
                splitByObject: any = null, color: string, alias: string, contextMenu: Array<any>, visibilityState: Array<any> = null, intepolationFunction: string, includeEnvelope: boolean){
        super(searchSpan, color, alias, contextMenu, measureTypes, intepolationFunction, includeEnvelope);
