...
class AvailabilityChart extends ChartComponent{
    ...
    private buildFromAndToContainer () {
        ...
        let timeframeLabel = dateTimeContainer.append("label").text('aaaa').attr("id", "time-frame-label");
        let dateTimeButtonContainer = dateTimeContainer.append("div")
            .classed('tsi-dateTimeButtonContainer', true).attr("aria-labelledby", 'time-frame-label');;
